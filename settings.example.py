...
# Zot_bib_web can automatically order all items in this collection by
# year, or by publication type (journal, conference).

# You can also create sub-collections, like so:
...
# The numbers at the beginning of the subcollection titles are for ordering.
# They will not be displayed.
# A * at the beginning means that this subcollection will be shown in an
# abbreviated style.
...
show_top_section_headings = True  # show section headings for the primary search criterion
